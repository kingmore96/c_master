...
# options passed:  -imultiarch x86_64-linux-gnu flex_arr.c -mtune=generic
...
.LFB6:
	...
	subq	$16, %rsp	#,
# flex_arr.c:11: 	struct sample *s = malloc(sizeof(struct sample) + 10 * sizeof(char));
	movl	$14, %edi	#,
	call	malloc@PLT	#
	movq	%rax, -8(%rbp)	# tmp86, s
# flex_arr.c:12: 	(*s).str[0] = 'a';
	movq	-8(%rbp), %rax	# s, tmp87
	movb	$97, 4(%rax)	#, *s_5
# flex_arr.c:13: 	printf("%c\n",(*s).str[0]);
	movq	-8(%rbp), %rax	# s, tmp88
	movzbl	4(%rax), %eax	# *s_5, _1
# flex_arr.c:13: 	printf("%c\n",(*s).str[0]);
	movsbl	%al, %eax	# _1, _2
	movl	%eax, %esi	# _2,
	leaq	.LC0(%rip), %rdi	#,
